...
-   discordPresence: enables a Discord Rich Presence showing some informations about your renderer such as score, average render time, average upload time and status`
## Build
